...
public class Custom_history extends ArrayAdapter<String>  implements JsonResponse{
    ...
    public Custom_history(Activity context, String[] pname, String[] shopname, String[] price, String[] qty, String[] img, String[] des) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_custom_history, pname);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_custom_history, null, true);
